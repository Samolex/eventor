...
namespace Eventor_Project.Models.SqlRepository.ProjectRepository
{
    ...
    partial void InsertOrganizerUser(OrganizerUser instance);
    partial void UpdateOrganizerUser(OrganizerUser instance);
    partial void DeleteOrganizerUser(OrganizerUser instance);
    ...
    partial void DeleteUser(User instance);
		...
		public System.Data.Linq.Table<OrganizerUser> OrganizerUsers
		{
			get
			{
				return this.GetTable<OrganizerUser>();
			}
		}
    ...
    partial void OnDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Customer_CustomerUser", Storage="_CustomerUsers", ThisKey="CustomerId", OtherKey="Customer_CustomerId")]
	...
	public partial class CustomerUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _Customer_CustomerId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnCustomer_CustomerIdChanging(int value);
    partial void OnCustomer_CustomerIdChanged();
    ...
    partial void OnUser_UserIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Customer_CustomerId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Customer_CustomerId
		{
			get
			{
				return this._Customer_CustomerId;
			}
			set
			{
				if ((this._Customer_CustomerId != value))
				{
					if (this._Customer.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnCustomer_CustomerIdChanging(value);
					this.SendPropertyChanging();
					this._Customer_CustomerId = value;
					this.SendPropertyChanged("Customer_CustomerId");
					this.OnCustomer_CustomerIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Customer_CustomerUser", Storage="_Customer", ThisKey="Customer_CustomerId", OtherKey="CustomerId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Customer Customer
		{
			...
			set
			{
							...
							|| (this._Customer.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Customer_CustomerId = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CustomerUser", Storage="_User", ThisKey="User_UserId", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public User User
		{
			get
			{
	...
	public partial class Organizer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<OrganizerUser> _OrganizerUsers;
    ...
    partial void OnNameChanged();
		...
		public Organizer()
		{
			this._OrganizerUsers = new EntitySet<OrganizerUser>(new Action<OrganizerUser>(this.attach_OrganizerUsers), new Action<OrganizerUser>(this.detach_OrganizerUsers));
			this._Project = default(EntityRef<Project>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Organizer_OrganizerUser", Storage="_OrganizerUsers", ThisKey="OrganizerId", OtherKey="Organizer_OrganizerId")]
		public EntitySet<OrganizerUser> OrganizerUsers
		{
			get
			{
				return this._OrganizerUsers;
			}
			set
			{
				this._OrganizerUsers.Assign(value);
			}
		}
		...
		private void attach_OrganizerUsers(OrganizerUser entity)
		{
			this.SendPropertyChanging();
			entity.Organizer = this;
		}
		
		private void detach_OrganizerUsers(OrganizerUser entity)
		{
			this.SendPropertyChanging();
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.OrganizerUsers")]
	public partial class OrganizerUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _Organizer_OrganizerId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnOrganizer_OrganizerIdChanging(int value);
    partial void OnOrganizer_OrganizerIdChanged();
    partial void OnUser_UserIdChanging(int value);
    partial void OnUser_UserIdChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Organizer_OrganizerId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Organizer_OrganizerId
		{
			get
			{
				return this._Organizer_OrganizerId;
			}
			set
			{
				if ((this._Organizer_OrganizerId != value))
				{
					if (this._Organizer.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnOrganizer_OrganizerIdChanging(value);
					this.SendPropertyChanging();
					this._Organizer_OrganizerId = value;
					this.SendPropertyChanged("Organizer_OrganizerId");
					this.OnOrganizer_OrganizerIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Organizer_OrganizerUser", Storage="_Organizer", ThisKey="Organizer_OrganizerId", OtherKey="OrganizerId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._Organizer.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.OrganizerUsers.Remove(this);
					}
					this._Organizer.Entity = value;
					if ((value != null))
					{
						value.OrganizerUsers.Add(this);
						this._Organizer_OrganizerId = value.OrganizerId;
					}
					else
					{
						this._Organizer_OrganizerId = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_OrganizerUser", Storage="_User", ThisKey="User_UserId", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public User User
		{
			get
			{
    ...
    partial void OnPlaceOfLiving_PlaceIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CustomerUser", Storage="_CustomerUsers", ThisKey="UserId", OtherKey="User_UserId")]
		public EntitySet<CustomerUser> CustomerUsers
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_OrganizerUser", Storage="_OrganizerUsers", ThisKey="UserId", OtherKey="User_UserId")]
		public EntitySet<OrganizerUser> OrganizerUsers
		{
			get
			{
